...
def render(time):
    ...
    for i in range(10):  
        for j in range(10): 
            ...
            M_matrix = glm.translate(glm.mat4(1.0), glm.vec3(i * 2.0, j * 2.0, 0.0))
